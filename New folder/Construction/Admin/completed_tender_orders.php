...
<div class="card" style="margin-bottom: 10%; margin-left: 5%; margin-right: 5%">
    ...
    <div class="table-responsive">
        <table class="table align-items-center table-flush" style="width: 1100px">
            ...
            <tbody>
                <?php
                $que = "SELECT * FROM e_tender WHERE status='Completed'";
                $res = mysqli_query($con, $que);
                while ($r = mysqli_fetch_array($res)) {
                    $query = "SELECT * from e_form WHERE eform_id=" . $r['eform_id'];
                ...
                ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php
                                $query1 = "SELECT * FROM user,requirement_form WHERE requirement_form.user_id=user.id AND requirement_form.status='Completed' AND requirement_form.form_id=" . $row['requirement_form_id'];
