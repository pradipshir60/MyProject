...
<div class="container-fluid" id="container-wrapper">
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Registered Contractors</h1>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="./">Home</a></li>
      <li class="breadcrumb-item">Contractors</li>
      <li class="breadcrumb-item active" aria-current="page">Registered Contractors</li>
    </ol>
  </div>
        ...
        <div class="table-responsive">
          <table class="table align-items-center table-flush">
            ...
            <tbody>
              <tr>
                <td colspan="4">
                  <a href="#" data-toggle="modal" data-target="#add_contractor">+ Add Contractor</a>

                  <div class="modal fade" id="add_contractor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <a href="update_contractor.php?contractor_id=<?php echo $row['contractor_id']; ?>" class="btn btn-warning"><span><i class="fas fa-edit"></i></span></a>
                    <a href="delete_contractor.php?contractor_id=<?php echo $row['contractor_id']; ?>" class="btn btn-danger"><span><i class="fas fa-trash"></i></span></a>
                  </td>
                </tr>
              <?php
              }
...
<script>
  $(document).ready(function() {
    ...
    $('#buttonClick').click(function() {
      ...
      window.location.href = "add_contractor.php?name=" + name + "&&email=" + email + "&&password=" + password;
    });
  });
</script>
