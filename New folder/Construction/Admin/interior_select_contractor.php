    ...
    <div class="table-responsive">
        <table class="table align-items-center table-flush" style="width: 1100px">
            ...
            <tbody>
                ...
                $query = "SELECT * from i_form WHERE status=0";
                ...
                ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <?php
                            $query1 = "SELECT * FROM user,interior_form WHERE interior_form.user_id=user.id AND interior_form.status='No Action' AND interior_form.interior_form_id=" . $row['interior_form_id'];
                            ...
                            ?>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <a href="interior_contractor_select.php?interior_form_id=<?php echo $rows1['interior_form_id']; ?>&&contractor_id=<?php echo $rows2['contractor_id'] ?>&&iform_id=<?php echo $row['iform_id']; ?>" class="btn btn-warning">Apply</a>
                                        <a href="interior_contractor_reject.php?interior_form_id=<?php echo $rows1['interior_form_id']; ?>&&contractor_id=<?php echo $rows2['contractor_id'] ?>&&iform_id=<?php echo $row['iform_id']; ?>" class="btn btn-danger">Reject</a>
                                    </td>
                        </tr>
        <?php
                                    break;
