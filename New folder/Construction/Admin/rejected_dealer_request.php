...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800" style="margin-left: 10%">Approved Dealers</h1>
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./">Home</a></li>
        <li class="breadcrumb-item">Approved Dealers</li>
    </ol>
</div>
    ...
    <div class="table-responsive scrollable">
        <table class="table align-items-center table-flush" style="text-align: center">
            ...
            <tbody>
                ...
                $query = "SELECT * from dealer WHERE status=2";
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="update_dealer.php?dealer_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary" style="margin: auto">Edit</a>
