...
?>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin-bottom: 12%">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Applied For Interior Form</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./">Home</a></li>
                <li class="breadcrumb-item" aria-current="page">Interior Requirement Form</li>
                                ...
                                ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="cancel_form.php?form_id=<?php echo $row['interior_form_id']; ?>" class="btn btn-danger">Cancel</a></td>
                                        <?php
                                                }
