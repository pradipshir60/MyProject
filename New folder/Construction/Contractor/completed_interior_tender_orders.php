    ...
    <div class="container-fluid" id="container-wrapper" style="margin-bottom: 12%">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Completed Tender Orders</li>
            </ol>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * from interior_tender WHERE status='Completed' AND contractor_id=" . $_SESSION['contractor_id'];
