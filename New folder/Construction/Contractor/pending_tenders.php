...
?>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin-bottom: 12%">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Pending Orders (Admin Allocation is remaining)</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./">Home</a></li>
                <li class="breadcrumb-item" aria-current="page">e-tender</li>
                <li class="breadcrumb-item active" aria-current="page">Pending Tenders</li>
            </ol>
        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * from e_form WHERE status=0 AND contractor_id=" . $_SESSION['contractor_id'];
