  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="table-responsive">
            ...
            $query = "SELECT * from e_tender WHERE status='Accepted' AND contractor_id=".$_SESSION['contractor_id'];
            ...
            while($row = mysqli_fetch_array($result))
            {
                ...
                <?php
                    $query2 = "SELECT * FROM e_form WHERE status=1 AND contractor_id=".$_SESSION['contractor_id'];
                    ...
                    <td>
                        <a href="complete_tender.php?tender_id=<?php echo $row['tender_id'] ?>&&form_id=<?php echo $row1['form_id']; ?>" class="btn btn-block btn-info"><span><i class="fas fa-check"></i></span></a>
                        <a href="delete_tender.php?tender_id=<?php echo $row['tender_id'] ?>&&form_id=<?php echo $row1['form_id']; ?>" class="btn btn-block btn-danger"><span><i class="fas fa-trash"></i></span></a>
                    </td>
                    </tr>
                <?php
                    }
