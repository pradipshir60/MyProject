...
if (isset($_SESSION['contractor_id'])) {
    ...
    $query = "SELECT * FROM e_tender WHERE requirement_form_id=" . $form_id;
        ...
        <div class="container-fluid" id="container-wrapper" style="margin-bottom: 12%">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Upload Tender</li>
                </ol>
            </div>

            <form method="POST" action="e-form_submit.php" enctype="multipart/form-data">
