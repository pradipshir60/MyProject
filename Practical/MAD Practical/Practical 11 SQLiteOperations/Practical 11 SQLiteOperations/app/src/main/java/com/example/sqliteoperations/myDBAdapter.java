...
class myDbAdapter {
    ...
    public String getData()
    {
        ...
        @SuppressLint("Recycle") Cursor cursor =db.query(myDbHelper.TABLE_NAME,columns,null,null,null,null,null);
        StringBuffer buffer;
    ...
    public  int delete(String uname)
    {
        ...
        int count;
        count = db.delete(myDbHelper.TABLE_NAME ,myDbHelper.NAME+" = ?",whereArgs);
        return  count;
    }
    public int updateName(String oldName , String newName)
    {
        ...
        int count;
        count = db.update(myDbHelper.TABLE_NAME,contentValues, myDbHelper.NAME+" = ?",whereArgs );
        return count;
    }
